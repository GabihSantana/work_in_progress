...
urls=(
    "https://diaad.s3.sa-east-1.amazonaws.com/sim/Mortalidade_Geral_2012.csv"
    "https://diaad.s3.sa-east-1.amazonaws.com/sim/Mortalidade_Geral_2013.csv"
    "https://diaad.s3.sa-east-1.amazonaws.com/sim/Mortalidade_Geral_2014.csv"
    "https://diaad.s3.sa-east-1.amazonaws.com/sim/Mortalidade_Geral_2015.csv"
    "https://diaad.s3.sa-east-1.amazonaws.com/sim/Mortalidade_Geral_2016.csv"
    "https://diaad.s3.sa-east-1.amazonaws.com/sim/Mortalidade_Geral_2017.csv"
    "https://diaad.s3.sa-east-1.amazonaws.com/sim/Mortalidade_Geral_2018.csv"
    ...
    "https://s3.sa-east-1.amazonaws.com/ckan.saude.gov.br/SIM/Mortalidade_Geral_2021.csv"
...
iconv -f US-ASCII -t UTF-8 Mortalidade_Geral_2013.csv > ./utf8/Mortalidade_Geral_2013.csv
iconv -f US-ASCII -t UTF-8 Mortalidade_Geral_2014.csv > ./utf8/Mortalidade_Geral_2014.csv
iconv -f US-ASCII -t UTF-8 Mortalidade_Geral_2015.csv > ./utf8/Mortalidade_Geral_2015.csv
iconv -f US-ASCII -t UTF-8 Mortalidade_Geral_2016.csv > ./utf8/Mortalidade_Geral_2016.csv
iconv -f US-ASCII -t UTF-8 Mortalidade_Geral_2017.csv > ./utf8/Mortalidade_Geral_2017.csv
iconv -f US-ASCII -t UTF-8 Mortalidade_Geral_2018.csv > ./utf8/Mortalidade_Geral_2018.csv
iconv -f US-ASCII -t UTF-8 Mortalidade_Geral_2019.csv > ./utf8/Mortalidade_Geral_2019.csv
iconv -f US-ASCII -t UTF-8 Mortalidade_Geral_2020.csv > ./utf8/Mortalidade_Geral_2020.csv
iconv -f US-ASCII -t UTF-8 Mortalidade_Geral_2021.csv > ./utf8/Mortalidade_Geral_2021.csv
iconv -f US-ASCII -t UTF-8 DO22OPEN.csv > ./utf8/Mortalidade_Geral_2022.csv
