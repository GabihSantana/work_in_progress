-- DROP PROCEDURE sim_data.SPR_Analise_Exploratoria_Alzheimer_Paliativa;

DELIMITER $$
CREATE PROCEDURE sim_data.SPR_Analise_Exploratoria_Alzheimer_Paliativa(IN tabela VARCHAR(100))
BEGIN 
	DECLARE linhas INT;
	...
	-- Criar tabela temporária com os casos
    SET @query1 = CONCAT('
		CREATE TABLE ', TabelaTemp, ' AS
    ...
    -- Enriquecer com as informações externas
    SET @query2 = CONCAT(
			'CREATE TABLE ', nomeTabelaFinal, ' AS
				SELECT 
					a.CONTADOR,
