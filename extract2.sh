...
echo "===============TRANSFORM================"
./csvtosql/csvtosql-bin   Idade.sv > ./sql/idade.sql
...
echo "================LOADER=================="
mysql -u developer --password=ifsp@123 sim_data  < ./sql/idade.sql
mysql -u developer --password=ifsp@123 sim_data  < ./sql/nacionalidade.sql
mysql -u developer --password=ifsp@123 sim_data  < ./sql/ocupacao.sql
